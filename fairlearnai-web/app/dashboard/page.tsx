                ...
                <div className="max-w-7xl mx-auto rounded-2xl bg-white/90 backdrop-blur-xl border border-slate-200/60 shadow-lg shadow-slate-200/20 pointer-events-auto transition-all duration-300">
                    <div className="flex items-center justify-between px-4 py-3 md:px-6 md:py-3.5">
                        ...
                        <div className="hidden lg:flex items-center flex-1 max-w-md mx-8 relative group">
                            ...
                            <input 
                                type="text" 
                                placeholder="Search courses, peers, or topics..." 
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-emerald-100 to-teal-100 border-2 border-white shadow-md cursor-pointer hover:shadow-lg transition-transform hover:scale-105" />
                        </div>
                    </div>
                </div>
            </header>
            ...
            >
                ...
                <AnimatePresence>
                    {!focusMode && (
                        ...
                        >
                            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-emerald-500/20 rounded-full blur-[100px] -mr-32 -mt-48 pointer-events-none" />
                            <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-teal-500/10 rounded-full blur-[80px] -ml-20 -mb-32 pointer-events-none" />
                            ...
                            <div className="flex items-center gap-5 relative z-10">
                                ...
                                <div className="py-1">
                                    <div className="flex items-center gap-3 mb-0.5">
                                        <h3 className="font-bold text-base tracking-tight text-white">Mid-Term Exams</h3>
                                        <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-300 text-[10px] font-bold border border-emerald-500/20 uppercase tracking-wide shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                                            New Schedule
                                        </span>
                                    </div>
                                    <p className="text-sm text-slate-300 font-medium leading-relaxed">Dates have been updated. Check your calendar.</p>
                                </div>
                            </div>

                            <div className="flex items-center gap-4 relative z-10">
                                <button className="hidden sm:flex items-center gap-2 px-5 py-2.5 bg-white text-slate-950 text-xs font-bold rounded-xl hover:bg-emerald-50 transition-all shadow-[0_4px_14px_0_rgba(0,0,0,0.1)] hover:shadow-[0_6px_20px_rgba(255,255,255,0.15)] active:scale-95 ring-1 ring-slate-200">
                                    View Schedule <Sparkles className="w-3 h-3 text-emerald-600" />
                                </button>
