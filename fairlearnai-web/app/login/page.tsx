...
import { Mail, Lock, ArrowRight, GraduationCap, School } from 'lucide-react'
...
export default function LoginPage() {
    ...
    return (
        ...
        <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-slate-50 px-4">
            {/* Background Effects */}
            ...
            <div className="absolute left-0 top-0 -z-10 h-full w-full bg-white [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#e0e7ff_100%)] opacity-60"></div>
            ...
            >
                <div className="mb-8 text-center">
                    ...
                    >
                        Sign in to FairLearnAI to continue your journey
                    </motion.p>
                </div>
                ...
                <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white/80 backdrop-blur-xl shadow-2xl shadow-slate-200/50">
                    <div className="p-8">
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="email" className="text-slate-700 ml-1 font-semibold">Username</Label>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between ml-1">
                                    <Label htmlFor="pwd" className="text-slate-700 font-semibold">Password</Label>
                                    <Link
                            ...
                            <Button className="w-full h-11 bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 text-white font-bold rounded-xl shadow-lg shadow-emerald-500/20 transition-all hover:scale-[1.02] hover:shadow-emerald-500/30">
                                Sign In
                    ...
                    <div className="border-t border-slate-100 bg-slate-50/50 p-4 text-center">
                        <p className="text-sm text-slate-500 font-medium">
                            ...
                            <Link href="/sign-up" className="font-bold text-emerald-600 hover:text-emerald-500 underline-offset-4 hover:underline">
                                Create account
                            </Link>
                        </p>
                    </div>
