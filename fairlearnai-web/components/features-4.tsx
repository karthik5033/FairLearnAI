...
export default function Features() {
    return (
        <section id="features" className="py-24 relative overflow-hidden bg-white dark:bg-zinc-950">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] opacity-20 dark:opacity-10 bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 blur-[100px] rounded-full pointer-events-none" />
            ...
            <div className="relative mx-auto max-w-5xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center mb-12">
                    ...
                    >
                        <h2 className="text-sm font-bold tracking-widest text-indigo-500 uppercase mb-3">
                            Features
                        </h2>
                        <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-zinc-900 dark:text-white mb-6">
                            Everything you need to <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">excel</span>
                        </h2>
